...
BEGIN {
  if (-e 't_Mail-SpamAssassin/test_dir') { # if we are running "t/rule_tests.t", kluge around ...
    chdir 't_Mail-SpamAssassin';
  }
...
my %files = (
	"$prefix/t_Mail-SpamAssassin/data/nice/mime1" => [
	  join("\n", 'multipart/alternative','text/plain',
	             'multipart/mixed,text/plain','application/andrew-inset'),
	],

	"$prefix/t_Mail-SpamAssassin/data/nice/mime2" => [
	  join("\n",'audio/basic'),
	],

	"$prefix/t_Mail-SpamAssassin/data/nice/mime3" => [
	...
	"$prefix/t_Mail-SpamAssassin/data/nice/mime4" => [
	  join("\n", 'multipart/mixed','text/plain','image/pgm'),
	],

	"$prefix/t_Mail-SpamAssassin/data/nice/mime5" => [
	  join("\n", 'multipart/mixed','text/plain','image/pbm'),
	  'cfbc6b4dbe0d6fe764dd0e0f10023afb0eb0faa9',
	  '6c41ae723b78e63e3763473cd737b84fae366f80'
	],

	"$prefix/t_Mail-SpamAssassin/data/nice/mime6" => [
	  join("\n",'application/postscript'),
	],

	"$prefix/t_Mail-SpamAssassin/data/nice/mime7" => [
	  join("\n",'multipart/mixed','audio/basic','audio/basic'),
	],

	"$prefix/t_Mail-SpamAssassin/data/nice/mime8" => [
...
my $sa = Mail::SpamAssassin->new({
    rules_filename => "$prefix/t_Mail-SpamAssassin/log/test_rules_copy",
    site_rules_filename => "$prefix/t_Mail-SpamAssassin/log/test_default.cf",
